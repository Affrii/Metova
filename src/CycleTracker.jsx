        ...
        <div style={{
          ...
          <div className="fade-up-3" style={{
            ...
            {Array.from({ length: daysInMonth }).map((_, i) => {
              ...
              return (
                <div
                  key={day}
                  onClick={() => isToday && setShowLogSheet(true)}
                  style={{
                    aspectRatio: "1",
                    display: "flex",
                    alignItems: "center",
          ...
          <div className="fade-up-4" style={{
            ...
            <div style={{
              ...
              Based on your last logged period
            </div>
          </div>
          ...
          >
            ...
            <div className="fade-up-3" style={{
              ...
              {flowOptions.map((f) => (
                <button
                  key={f.label}
                  onClick={() => setSelectedFlow(f.label)}
                  style={{
                    padding: "12px 8px",
                    borderRadius: "12px",
                    border: selectedFlow === f.label
                      ? "1px solid #0D0D0D"
                      : "0.5px solid #E8E4F0",
                    backgroundColor: selectedFlow === f.label
                      ? "#E8E4F0"
                      : "#FDF0EC",
                    color: "#0D0D0D",
                    fontSize: "11px",
            ...
            >
              <div style={{ fontSize: "14px", color: "#0D0D0D" }}>
                Clotting present
              </div>
              <div style={{
                width: "44px",
