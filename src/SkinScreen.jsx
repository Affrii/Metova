...
function SkinScreen({ userData }) {
  ...
  { emoji: "🥬", name: "Palak (Spinach)", benefit: "Iron restores energy and glow" },
  { emoji: "🫘", name: "Masoor dal", benefit: "Protein reduces inflammation" },
  { emoji: "🌿", name: "Tulsi kadha", benefit: "Antioxidants calm skin flare-ups" },
],
    ...
    follicular: {
      ...
      foods: [
  { emoji: "🥥", name: "Coconut water", benefit: "Hydrates and brightens skin" },
  { emoji: "🫘", name: "Chana dal", benefit: "Zinc controls sebum production" },
  { emoji: "🥕", name: "Gajar (Carrots)", benefit: "Beta-carotene for natural glow" },
  { emoji: "🍋", name: "Nimbu pani", benefit: "Vitamin C brightens skin" },
],
    ...
    ovulatory: {
      ...
      foods: [
  { emoji: "🥦", name: "Broccoli sabzi", benefit: "Balances oestrogen naturally" },
  { emoji: "🌰", name: "Akhrot (Walnuts)", benefit: "Omega-3 reduces inflammation" },
  { emoji: "🍓", name: "Strawberries", benefit: "Vitamin C boosts collagen" },
  { emoji: "🫚", name: "Cold pressed til oil", benefit: "Sesame = supple skin" },
],
  ...
  { emoji: "🎃", name: "Kaddu ke beej", benefit: "Zinc fights hormonal acne" },
  { emoji: "🫙", name: "Homemade ghee", benefit: "Butyrate calms gut-skin axis" },
  { emoji: "🫐", name: "Jamun / dark berries", benefit: "Prevents inflammation" },
],
eupAvoid: ["Pore-clogging foundations", "Coconut oil-based products", "Fragrant products"],
