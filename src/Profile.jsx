              ...
              <div style={{ marginBottom: "20px" }}>
                ...
                <div style={{
                  ...
                  {cities
                    ...
                    .map((c, i, arr) => (
                      <div key={c} onClick={() => { setEditValue(c); setCitySearch("") }} style={{
                        padding: "14px 16px",
                        borderBottom: i < arr.length - 1 ? "0.5px solid #E8E4F0" : "none",
                        cursor: "pointer", fontSize: "14px",
                        fontFamily: "DM Sans, sans-serif",
                        color: editValue === c ? "#0D0D0D" : "#6B6560",
                        fontWeight: editValue === c ? "500" : "400",
                        backgroundColor: editValue === c ? "#E8E4F0" : "transparent",
                ...
                {editValue && (
                  <div style={{ marginTop: "10px", fontSize: "13px", color: "#0D0D0D", fontFamily: "DM Sans, sans-serif" }}>
                    Selected: <span style={{ fontWeight: "500" }}>{editValue}</span>
                  </div>
                )}
              </div>
            )}
