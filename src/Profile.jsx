...
function Profile({ userData, onSignOut }) {
  ...
  const dietType = userData?.dietType || "no restriction"
  const tier = "Free"
  ...
  const chevron = (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
      <path d="M9 18l6-6-6-6" stroke="#6B6560"
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div className="fade-up-2" style={{
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{
              fontSize: "12px", color: "#6B6560", marginBottom: "8px",
            }}>
              {city} · {pcosStatus}
            </div>
            <div style={{
      ...
      <div style={{
        ...
        {/* Health profile */}
        <label className="fade-up-3" style={sectionLabelStyle}>
          Health profile
        </label>
        <div className="fade-up-4" style={{ ...cardStyle, marginBottom: "20px" }}>
          <div style={rowStyle}>
            <div>
              ...
              <div style={rowSubStyle}>{dietType || "Not set"}</div>
            </div>
            {chevron}
          </div>
          <div style={rowStyle}>
          ...
          <div style={lastRowStyle}>
            <div>
              ...
              <div style={rowSubStyle}>
                {userData?.supplements?.length > 0
                  ? userData.supplements.join(", ")
                  : "None added"}
              </div>
            </div>
            {chevron}
        ...
        {/* Subscription */}
        <label className="fade-up-5" style={sectionLabelStyle}>
          Subscription
        </label>
        ...
        {/* Notifications */}
        <label className="fade-up-7" style={sectionLabelStyle}>
          Notifications
        </label>
        <div className="fade-up-8" style={{ ...cardStyle, marginBottom: "20px" }}>
          <div style={rowStyle}>
            <div>
              ...
              <div style={rowSubStyle}>
                Period predictions + phase changes
              </div>
            </div>
            <div style={toggleStyle(cycleAlertsOn)}
              onClick={() => setCycleAlertsOn(!cycleAlertsOn)}>
          ...
          <div style={rowStyle}>
            ...
            <div style={toggleStyle(horoscopeOn)}
              onClick={() => setHoroscopeOn(!horoscopeOn)}>
          ...
          <div style={lastRowStyle}>
            ...
            <div style={toggleStyle(notificationsOn)}
        ...
        {/* Connected devices */}
        <label className="fade-up-9" style={sectionLabelStyle}>
          Connected devices
        </label>
        ...
        {/* Data & privacy */}
        <label className="fade-up-10" style={sectionLabelStyle}>
          Data & privacy
        </label>
        <div className="fade-up-10" style={{ ...cardStyle, marginBottom: "20px" }}>
          <div style={rowStyle}>
        ...
        <div className="fade-up-10">
          ...
          <div style={{
            ...
            Metova is not a medical device and does not provide
